...
{
    if (argc!=2) {
        cout << "Usage: pressurizationDisplacement3D configDir/configName" << endl;
        return EXIT_FAILURE;
    }

    std::cout << "Pressurization simulation started at " << Timer::printTime() << std::endl;
    ...
    const size_t maxIter     = displacements.stepsCount();
...
//        if(iter + 2 < displacements.stepsCount()) {
